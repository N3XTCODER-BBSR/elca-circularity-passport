...
| CSV‑Exports (Material/aggregiert)                           | [app/(utils)/csvExportUtils.ts](<../../app/(utils)/csvExportUtils.ts>)<br>[mapCircularityDataToMaterialCsvTransformer.ts](<../../app/%5Blocale%5D/(circularity)/(web-optimized)/projects/%5BprojectId%5D/variants/%5BvariantId%5D/(index)/(components)/CircularityIndexBreakdownByMaterialType/MaterialCsvExport/mapCircularityDataToMaterialCsvTransformer.ts>)<br>[mapCircularityDataToAggregatedInventoryCsvTransformer.ts](<../../app/%5Blocale%5D/(circularity)/(web-optimized)/projects/%5BprojectId%5D/variants/%5BvariantId%5D/(index)/(components)/BuildingOverview/CircularityDataCsvExport/mapCircularityDataToAggregatedInventoryCsvTransformer.ts>) |
