...
Welcome to the _eLCA-Passport_, an open-source project dedicated to providing comprehensive "passports" for buildings, each containing detailed Environmental Life Cycle Assessment (eLCA) information.

## Features and Used Technology

The project leverages the most modern tech stack, ensuring cutting-edge performance, scalability, and security in the development and deployment:
...
The project comes with various testing setups to ensure your application's reliability and robustness.
