...
describe("getElcaComponentDataByProductId", () => {
  ...
  describe("authorization", () => {
    ...
    it("returns Unauthorized error message if user does not exist", async () => {
    ...
    it("returns Unauthorized error message if user lacks project access", async () => {
    ...
    it("returns Unauthorized error message if user is not in the project (unauthorized user)", async () => {
    ...
    it("returns DAL error message if user is project owner but the productId is not part of the project", async () => {
      ...
      ).resolves.toMatchObject({ success: false, message: expect.stringContaining("Error in DAL") })
    })

    it("returns DAL error message if user is project owner but the variant is not part of the project", async () => {
    ...
    describe("access tokens", () => {
      ...
      it("returns Unauthorized error message if user has only read access token and tries to fetch data from project1", async () => {
