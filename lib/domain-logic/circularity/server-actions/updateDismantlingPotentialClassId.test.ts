...
describe("updateDismantlingPotentialClassId", () => {
  describe("authorization", () => {
    ...
    it("should throw Unauthorized error when user is not existing", async () => {
      ...
      await expect(updateDismantlingPotentialClassId(productId, dismantlingPotentialClassId)).rejects.toThrow(
        UnauthorizedError
      )
    })
    ...
    it("should return undefined when the user is owner of the project", async () => {
      ...
      await expect(updateDismantlingPotentialClassId(productId, dismantlingPotentialClassId)).resolves.toBeUndefined()
    })
  })
})
