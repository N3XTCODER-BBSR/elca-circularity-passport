...
import { MaterialNode } from "app/[locale]/(circularity)/projects/[projectId]/variants/[variantId]/(index)/(components)/CircularityIndexBreakdownByMaterialType/CircularityIndexBreakdownByMaterialType"
 ...
 */
export function getMetricValue(material: MaterialNode, metricType: MetricType): number {
  switch (metricType) {
    case "eolBuiltPoints":
