...
import { toggleExcludedProduct as toggleExcludedProductDomain } from "lib/domain-logic/circularity/products/manageProductExclusion"
...
export const toggleExcludedProduct = async (productId: number) => {
  return withServerActionErrorHandling(async () => {
    ...
    await toggleExcludedProductDomain(productId)
  })
}
