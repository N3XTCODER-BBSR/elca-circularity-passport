...
import { upsertUserEnrichedProductDataByLayerId } from "lib/domain-logic/circularity/dismantling/updateDismantlingData"
...
export async function updateDismantlingPotentialClassId(
  ...
  return withServerActionErrorHandling(async () => {
    ...
    await upsertUserEnrichedProductDataByLayerId(productId, selectedDismantlingPotentialClassId)
  })
}
