...
import { getProductCircularityData } from "lib/domain-logic/circularity/products/manageProductData"

/**
 * Server action for retrieving component data and circularity calculations for a product
 *
...
const getElcaComponentDataByProductId = async (variantId: number, projectId: number, productId: number) => {
  return withServerActionErrorHandling(async () => {
    ...
    return getProductCircularityData(productId, variantId, projectId)
  })
}
