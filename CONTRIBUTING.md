...
✨ Thanks for contributing to **eLCA-Passport**! ✨
...
Participating in the discussion is a good opportunity to get involved and influence the future direction of **eLCA-Passport**.
...
Post a comment on an issue to indicate you would like to work on it and to request help from the [@eLCA-Passport/maintainers](https://github.com/orgs/semantic-release/teams/contributors) and the community.
